...
$route['manager/authenticate'] = 'Manager/user_authenticate';
$route['manager/create_account'] = 'Manager/user_create_account';
$route['manager/reset_account'] = 'Manager/user_reset_account';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
